...
| `system.kernel-dpc-watchdog-period` | deprecated | Class E | `research/records/system.kernel-dpc-watchdog-period.review.json` | - | `8fa129a7279d0363bc0f475c9a5451356417265d79d66a8bc0d0175c5f340430` | `caf8e59ea52f8c0784187875edca479290d13e5229afd771cbd3267ef71c42ee` | 9 |
...
| `system.kernel-dpc-watchdog-control-cluster` | draft | Class D | `research/records/system.kernel-dpc-watchdog-control-cluster.json` | - | `9742d6402a63079b2ea86a8b44507f93491e0b3c72c2fc982e3631f69ecf167f` |  | 8 |
| `system.kernel-dpc-watchdog-profile-cluster` | draft | Class D | `research/records/system.kernel-dpc-watchdog-profile-cluster.json` | - | `8a96d29401d251c46a886696066687bc6af13fee440be659e4f5db3af217ca69` |  | 10 |
...
- Source SHA256: `9742d6402a63079b2ea86a8b44507f93491e0b3c72c2fc982e3631f69ecf167f`
- Proof SHA256: ``

**Summary:** Draft Session Manager Kernel DPC watchdog control timeout cluster record. Repo docs list `DPCTimeout = 20000`, `DpcSoftTimeout = 20000`, and `DpcCumulativeSoftTimeout = 120000` under `HKLM\\SYSTEM\\CurrentControlSet\\Control\\Session Manager\\Kernel`. Current-build KVM evidence now proves the full structural lane plus live values: `KeQueryDpcWatchdogConfiguration` reads the corresponding globals, `KiValidateDpcWatchdogConfiguration` backfills and validates them, `KeUpdateDpcWatchdogConfiguration` writes them from caller-supplied validated input, a PDB-backed Ghidra pass ties the writer to `NtSetSystemInformation`, a later class-focused live KD pass confirms the exact syscall call site plus admin-group gate and implies numeric arm `0xE4` from the dispatch chain, a dedicated live value pass reads all three globals as `0` on the running build, and a canonical boot/init Ghidra follow-up shows that `KiInitDpcThresholds` preserves zero-valued control globals rather than forcing non-zero defaults. The family is real, but the current build does not support treating the repo-doc values as unconditional live defaults or as proven registry-seeded state.

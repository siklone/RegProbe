...
| `power.control.allow-audio-to-enable-execution-required-power-requests` | draft | Class D | `research/records/power.control.allow-audio-to-enable-execution-required-power-requests.json` | - | `dd1b5fa6fecef3aebd9966831c97f0770942a82549fe78cce096266d5364a348` |  | 6 |

...
- `procmon-trace` Win25H2Clean Procmon baseline for Defender MAPS policy path -> evidence/raw/procmon/security.enable-defender-maps-advanced-membership/spynet-ui-baseline.txt
- `procmon-trace` Win25H2Clean Procmon read for SpyNetReporting = 2 -> evidence/raw/procmon/security.disable-defender-sample-submission/spynet-ui-state2.txt

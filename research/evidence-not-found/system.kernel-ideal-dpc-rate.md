...
- `decompilation` nohuto mirror: ideal DPC rate query path -> research/_source-mirrors/decompiled-pseudocode/ntoskrnl/ExpQuerySystemInformation.c; research/_source-mirrors/win-config/system/desc.md

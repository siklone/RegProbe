...
- `official-doc` Microsoft Learn: Guidance on configuring system services - Print Scan Broker Service -> https://learn.microsoft.com/en-us/windows/iot/iot-enterprise/optimize/services
- `repo-doc` Local SCM snapshot - PrintScanBrokerService -> research/notes/service-snapshots/printscanbrokerservice-sc-qc-2026-03-14.txt

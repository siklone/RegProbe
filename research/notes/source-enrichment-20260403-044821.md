...
## Source Snapshot
- `reactos`: missing (root-missing), hits `0`
- `wrk`: missing (root-missing), hits `0`
- `systeminformer`: missing (root-missing), hits `0`
- `admx`: present, hits `13`
- `wdk_headers`: missing (root-missing), hits `0`
- `geoff_chappell`: missing (root-missing), hits `0`

...
- The next infrastructure phase should be `guest-restart` break-in/command-roundtrip validation plus pipe endpoint/start-order testing, not more key-specific RE.

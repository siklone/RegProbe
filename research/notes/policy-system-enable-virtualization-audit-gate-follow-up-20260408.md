...
- retained WPR/QGA no-hit audit: [policy-system-enable-virtualization-wpr-qga-runtime-read-20260413.json](../../registry-research-framework/audit/policy-system-enable-virtualization-wpr-qga-runtime-read-20260413.json)

...
- `research/evidence-files/vm-tooling-staging/taskbaranimations-procmon-20260326/taskbaranimations-state-0.txt`
- `research/evidence-files/vm-tooling-staging/taskbaranimations-procmon-20260326/taskbaranimations-state-0.hits.csv`
- `research/evidence-files/vm-tooling-staging/taskbaranimations-procmon-20260326/taskbaranimations-state-1.txt`
- `research/evidence-files/vm-tooling-staging/taskbaranimations-procmon-20260326/taskbaranimations-state-1.hits.csv`

Ghidra follow-up:

- Binary: `C:\Windows\System32\Taskbar.dll`
- String: `TaskbarAnimations`
- Export: `research/evidence-files/vm-tooling-staging/ghidra-probes/taskbar-taskbaranimations-ghidra-20260326-040246/taskbar-taskbaranimations-ghidra.md`

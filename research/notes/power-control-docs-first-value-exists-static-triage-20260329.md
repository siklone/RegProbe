...
- The checked-in repo already contains exact `Docs/power/power.md` references for all seven values, so the next useful work is candidate packaging rather than another existence pass.

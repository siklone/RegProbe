...
- This tree already contains exact `Docs/power/power.md` references for all seven values, so the next step is candidate packaging rather than another existence pass.

...
4. This means the candidate no longer depends on the later lightweight ETW no-query lane for its best runtime story; the stronger retained proof is the earlier stepwise Procmon boot trace.

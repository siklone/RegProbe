...
- [policy-system-enable-virtualization-path-aware-follow-up-20260330.json](../../registry-research-framework/audit/policy-system-enable-virtualization-path-aware-follow-up-20260330.json)

...
3. `watchdog-lightweight-runtime-20260330-131636/power-session-watchdog-timeouts/summary.json`
...
1. resolve the current-build symbol family around the watchdog timeout reader path
2. pivot from the generic helper surface (`PopOpenPowerKey`, `PopReadRegKeyValue`) to the watchdog-specific caller

...
- `policy.system.enable-virtualization`
  - checked-in blocker: generic string search collides with `EnableVirtualizationBasedSecurity`
...
- `system.io-allow-remote-dasd`
  - checked-in blocker: prior static routing collided with the removable-storage policy path
...
These two values remain out of the generic residual string-first queue until the substring and path-collision risks are removed.

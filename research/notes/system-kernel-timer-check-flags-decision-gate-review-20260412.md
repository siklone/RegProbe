...
The string/xref and KD work closed the earlier static-analysis uncertainty, but the checked-in build still gives us no exact runtime registry read, no primary checked-in-build documentation for the modern flag contract, and no proven interpretation for non-default bit combinations. That leaves the remaining work in a narrow but still unresolved semantics lane.

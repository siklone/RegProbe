...
- [power-control-docs-first-postboot-trigger-capture-20260329.json](../../registry-research-framework/audit/power-control-docs-first-postboot-trigger-capture-20260329.json)

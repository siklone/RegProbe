...
The current evidence keeps this as a useful kernel timer research lead, but it still lacks a primary current-build Microsoft document for the exact value and no retained runtime lane has captured an exact registry read.

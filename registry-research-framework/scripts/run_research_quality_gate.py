...
def default_steps(args: argparse.Namespace) -> list[GateStep]:
    ...
    return [
        ...
        GateStep(
            ...
            [python, "registry-research-framework/scripts/check_etw_stackwalk_reopen_decision_ledger.py"],
        ),
        GateStep(
        ...
        GateStep(
            ...
            [python, "registry-research-framework/scripts/check_etw_stackwalk_reopen_operator_brief.py"],
        ),
        GateStep(
            "etw-stackwalk-reopen-journal",
            "ETW stackwalk reopen journal check",
            [python, "registry-research-framework/scripts/check_etw_stackwalk_reopen_journal.py"],
        ),
        GateStep(
            "etw-stackwalk-reopen-snapshot",
            "ETW stackwalk reopen snapshot check",
            [python, "registry-research-framework/scripts/check_etw_stackwalk_reopen_snapshot.py"],
        ),
        GateStep(
            "etw-stackwalk-reopen-transition-summary",
            "ETW stackwalk reopen transition summary check",
            [python, "registry-research-framework/scripts/check_etw_stackwalk_reopen_transition_summary.py"],
        ),
        GateStep(
            "etw-stackwalk-reopen-baseline-archive",
            "ETW stackwalk reopen baseline archive check",
            [python, "registry-research-framework/scripts/check_etw_stackwalk_reopen_baseline_archive.py"],
        ),
        GateStep(
        ...
        GateStep(
            ...
            [python, "registry-research-framework/scripts/check_etw_stackwalk_reopen_seed_ack_journal.py"],
        ),
        GateStep(

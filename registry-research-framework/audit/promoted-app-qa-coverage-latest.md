...
- `explorer.show-file-extensions` | Show File Extensions | Explorer
- `explorer.show-full-path` | Show Full Path in Explorer | Explorer
- `explorer.show-hidden-files` | Show Hidden Files and Folders | Explorer
...
- `explorer.show-status-bar` | Show Status Bar | Explorer

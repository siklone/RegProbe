...
| 21 | `DisableExceptionChainValidation` | `known-absent` | `boolean-toggle` | `1`:source-backed, `0`:name-rule | `eligible=False` `rollback-not-tested`, `security-mitigation-override` | evidence-lanes-open-or-covered |
...
| 34 | `DisableControlFlowGuardExportSuppression` | `known-absent` | `boolean-toggle` | `1`:source-backed, `0`:name-rule | `eligible=False` `rollback-not-tested`, `security-mitigation-override` | evidence-lanes-open-or-covered |
...
| 59 | `TtmEnabled` | `known-absent` | `boolean-toggle` | `0`:source-backed, `1`:name-rule | `eligible=False` `rollback-not-tested` | evidence-lanes-open-or-covered |
...
| 65 | `SleepstudyAccountingEnabled` | `known-absent` | `boolean-toggle`, `count-boundary` | `0`:source-backed, `1`:name-rule | `eligible=False` `rollback-not-tested` | evidence-lanes-open-or-covered |
...
| 93 | `Policy` | `known-absent` | - | `1`:source-backed | `eligible=False` `key-missing-in-target-vm`, `rollback-not-tested` | no-evidence-found-on-win11-25h2 |
...
| 96 | `PowerThrottlingOff` | `known-absent` | `boolean-toggle` | `1`:source-backed, `0`:name-rule | `eligible=False` `key-missing-in-target-vm`, `rollback-not-tested` | evidence-lanes-open-or-covered |

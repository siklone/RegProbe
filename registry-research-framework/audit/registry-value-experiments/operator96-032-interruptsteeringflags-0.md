...
- Status: **ok**
- Generated UTC: `2026-05-09T18:58:16Z`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4416`, cpu_multi_seconds=`0.253`, io_mib_s=`426.26`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4378`, cpu_multi_seconds=`0.247`, io_mib_s=`90.38`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.47`, cpu_multi_seconds=`0.2389`, io_mib_s=`349.36`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.5121`, cpu_multi_seconds=`0.37`, io_mib_s=`432.74`

...
- Status: **ok**
- Generated UTC: `2026-05-09T21:55:09Z`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4732`, cpu_multi_seconds=`0.286`, io_mib_s=`342.09`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4439`, cpu_multi_seconds=`0.2431`, io_mib_s=`278.05`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4608`, cpu_multi_seconds=`0.3717`, io_mib_s=`305.9`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4655`, cpu_multi_seconds=`0.2431`, io_mib_s=`94.03`

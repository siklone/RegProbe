# Registry Value Experiment - operator96-018-disablelightweightsuspend-1

- Status: **ok**
- Generated UTC: `2026-05-09T13:02:34Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel\DisableLightWeightSuspend`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4696`, cpu_multi_seconds=`0.2363`, io_mib_s=`439.25`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4357`, cpu_multi_seconds=`0.2161`, io_mib_s=`464.82`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4377`, cpu_multi_seconds=`0.2185`, io_mib_s=`472.97`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4395`, cpu_multi_seconds=`0.22`, io_mib_s=`252.81`

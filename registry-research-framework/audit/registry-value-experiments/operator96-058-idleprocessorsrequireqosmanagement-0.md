# Registry Value Experiment - operator96-058-idleprocessorsrequireqosmanagement-0

- Status: **ok**
- Generated UTC: `2026-05-09T23:13:08Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Power\IdleProcessorsRequireQosManagement`
- Test value: `0`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4356`, cpu_multi_seconds=`0.2261`, io_mib_s=`427.61`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4594`, cpu_multi_seconds=`0.2648`, io_mib_s=`303.62`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4355`, cpu_multi_seconds=`0.2294`, io_mib_s=`408.09`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4844`, cpu_multi_seconds=`0.2595`, io_mib_s=`281.35`

# Registry Value Experiment - operator96-023-enabletickaccumulationfromaccountingperiods-1

- Status: **ok**
- Generated UTC: `2026-05-09T16:01:59Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel\EnableTickAccumulationFromAccountingPeriods`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4649`, cpu_multi_seconds=`0.2581`, io_mib_s=`417.88`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.442`, cpu_multi_seconds=`0.2303`, io_mib_s=`506.69`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4468`, cpu_multi_seconds=`0.2228`, io_mib_s=`514.28`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4771`, cpu_multi_seconds=`0.3563`, io_mib_s=`362.58`

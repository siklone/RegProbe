# Registry Value Experiment - operator96-003-additionalcriticalworkerthreads-5

- Status: **ok**
- Generated UTC: `2026-05-09T09:33:36Z`
...
- `after_apply`: status=`value-present`, value_exists=`True`, value=`5`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4718`, cpu_multi_seconds=`0.2624`, io_mib_s=`318.45`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4576`, cpu_multi_seconds=`0.242`, io_mib_s=`301.8`
...
- `after_reboot`: status=`value-present`, value_exists=`True`, value=`5`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4736`, cpu_multi_seconds=`0.2582`, io_mib_s=`309.56`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4571`, cpu_multi_seconds=`0.237`, io_mib_s=`296.11`

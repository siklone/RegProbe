# Registry Value Experiment - operator96-003-additionalcriticalworkerthreads-1

- Status: **ok**
- Generated UTC: `2026-05-09T09:37:21Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Executive\AdditionalCriticalWorkerThreads`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4751`, cpu_multi_seconds=`0.2779`, io_mib_s=`278.98`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4526`, cpu_multi_seconds=`0.2372`, io_mib_s=`330.39`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4823`, cpu_multi_seconds=`0.2379`, io_mib_s=`198.24`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4745`, cpu_multi_seconds=`0.2491`, io_mib_s=`315.14`

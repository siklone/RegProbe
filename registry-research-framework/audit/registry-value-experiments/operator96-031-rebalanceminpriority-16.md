# Registry Value Experiment - operator96-031-rebalanceminpriority-16

- Status: **ok**
- Generated UTC: `2026-05-09T18:09:58Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel\RebalanceMinPriority`
- Test value: `16`
...
- `after_apply`: status=`value-present`, value_exists=`True`, value=`16`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4466`, cpu_multi_seconds=`0.2491`, io_mib_s=`372.54`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4548`, cpu_multi_seconds=`0.4462`, io_mib_s=`373.99`
...
- `after_reboot`: status=`value-present`, value_exists=`True`, value=`16`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4595`, cpu_multi_seconds=`0.2587`, io_mib_s=`342.26`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4761`, cpu_multi_seconds=`0.2357`, io_mib_s=`356.38`

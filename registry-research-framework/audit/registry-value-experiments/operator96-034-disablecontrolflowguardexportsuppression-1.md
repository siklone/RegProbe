# Registry Value Experiment - operator96-034-disablecontrolflowguardexportsuppression-1

- Status: **ok**
- Generated UTC: `2026-05-09T19:15:23Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel\DisableControlFlowGuardExportSuppression`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4527`, cpu_multi_seconds=`0.2608`, io_mib_s=`76.87`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4972`, cpu_multi_seconds=`0.2539`, io_mib_s=`361.79`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.6297`, cpu_multi_seconds=`0.3476`, io_mib_s=`362.61`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.5963`, cpu_multi_seconds=`0.3099`, io_mib_s=`216.03`

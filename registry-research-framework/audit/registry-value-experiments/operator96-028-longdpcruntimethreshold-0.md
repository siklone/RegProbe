...
- Status: **ok**
- Generated UTC: `2026-05-09T17:28:22Z`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4931`, cpu_multi_seconds=`0.28`, io_mib_s=`275.06`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4728`, cpu_multi_seconds=`0.3002`, io_mib_s=`312.99`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.493`, cpu_multi_seconds=`0.2666`, io_mib_s=`271.61`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4613`, cpu_multi_seconds=`0.3122`, io_mib_s=`325.99`

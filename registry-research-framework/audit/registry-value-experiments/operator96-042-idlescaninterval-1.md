# Registry Value Experiment - operator96-042-idlescaninterval-1

- Status: **ok**
- Generated UTC: `2026-05-09T20:47:53Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Power\IdleScanInterval`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4318`, cpu_multi_seconds=`0.2207`, io_mib_s=`433.95`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4309`, cpu_multi_seconds=`0.2198`, io_mib_s=`386.3`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4343`, cpu_multi_seconds=`0.3181`, io_mib_s=`425.97`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4311`, cpu_multi_seconds=`0.2197`, io_mib_s=`419.81`

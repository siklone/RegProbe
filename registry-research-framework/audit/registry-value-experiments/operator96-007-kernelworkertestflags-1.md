# Registry Value Experiment - operator96-007-kernelworkertestflags-1

- Status: **ok**
- Generated UTC: `2026-05-09T11:37:57Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Executive\KernelWorkerTestFlags`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4599`, cpu_multi_seconds=`0.2543`, io_mib_s=`196.64`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4831`, cpu_multi_seconds=`0.2667`, io_mib_s=`70.79`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4999`, cpu_multi_seconds=`0.2969`, io_mib_s=`210.77`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.528`, cpu_multi_seconds=`0.2724`, io_mib_s=`253.3`

# Registry Value Experiment - operator96-031-rebalanceminpriority-0

- Status: **ok**
- Generated UTC: `2026-05-09T18:15:50Z`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4474`, cpu_multi_seconds=`0.2535`, io_mib_s=`341.7`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4501`, cpu_multi_seconds=`0.2392`, io_mib_s=`355.87`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4552`, cpu_multi_seconds=`0.2423`, io_mib_s=`359.46`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4448`, cpu_multi_seconds=`0.2521`, io_mib_s=`363.26`

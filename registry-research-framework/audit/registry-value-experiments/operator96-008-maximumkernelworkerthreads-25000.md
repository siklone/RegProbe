# Registry Value Experiment - operator96-008-maximumkernelworkerthreads-25000

- Status: **ok**
- Generated UTC: `2026-05-09T11:41:30Z`
...
- `after_apply`: status=`value-present`, value_exists=`True`, value=`25000`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.6387`, cpu_multi_seconds=`0.4265`, io_mib_s=`309.99`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4497`, cpu_multi_seconds=`0.2301`, io_mib_s=`46.1`
...
- `after_reboot`: status=`value-present`, value_exists=`True`, value=`25000`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.458`, cpu_multi_seconds=`0.3292`, io_mib_s=`230.73`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4633`, cpu_multi_seconds=`0.2512`, io_mib_s=`72.79`

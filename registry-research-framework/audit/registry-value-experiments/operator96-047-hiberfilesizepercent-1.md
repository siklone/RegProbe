...
- Status: **ok**
- Generated UTC: `2026-05-09T21:43:18Z`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4357`, cpu_multi_seconds=`0.2727`, io_mib_s=`266.26`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4374`, cpu_multi_seconds=`0.24`, io_mib_s=`393.25`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4591`, cpu_multi_seconds=`0.2549`, io_mib_s=`288.67`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4453`, cpu_multi_seconds=`0.2394`, io_mib_s=`308.78`

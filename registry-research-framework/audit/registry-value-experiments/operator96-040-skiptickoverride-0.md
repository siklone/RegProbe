# Registry Value Experiment - operator96-040-skiptickoverride-0

- Status: **ok**
- Generated UTC: `2026-05-09T20:18:57Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Power\SkipTickOverride`
- Test value: `0`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4567`, cpu_multi_seconds=`0.2563`, io_mib_s=`353.81`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4515`, cpu_multi_seconds=`0.2443`, io_mib_s=`336.38`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.5322`, cpu_multi_seconds=`0.2542`, io_mib_s=`215.68`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4573`, cpu_multi_seconds=`0.2584`, io_mib_s=`278.63`

# Registry Value Experiment - operator96-005-uuidsequencenumber-0

- Status: **ok**
- Generated UTC: `2026-05-09T09:53:34Z`
...
- `status`: `ok`
- `error`: `None`
- `original`: status=`value-present`, value_exists=`True`, value=`2636908`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.5747`, cpu_multi_seconds=`0.2641`, io_mib_s=`349.24`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.461`, cpu_multi_seconds=`0.2729`, io_mib_s=`306.65`
...
- `after_restore`: status=`value-present`, value_exists=`True`, value=`2636908`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4752`, cpu_multi_seconds=`0.2467`, io_mib_s=`346.02`

## Stage: post_rollback

- `status`: `ok`
- `error`: `None`
- `final`: status=`value-present`, value_exists=`True`, value=`2636909`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4543`, cpu_multi_seconds=`0.2402`, io_mib_s=`302.25`

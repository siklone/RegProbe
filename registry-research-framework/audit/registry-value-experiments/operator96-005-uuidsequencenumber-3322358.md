# Registry Value Experiment - operator96-005-uuidsequencenumber-3322358

- Status: **ok**
- Generated UTC: `2026-05-09T09:49:36Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Executive\UuidSequenceNumber`
- Test value: `3322358`
...
- `status`: `ok`
- `error`: `None`
- `original`: status=`value-present`, value_exists=`True`, value=`2636907`
- `after_apply`: status=`value-present`, value_exists=`True`, value=`3322358`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4908`, cpu_multi_seconds=`0.2533`, io_mib_s=`347.6`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4561`, cpu_multi_seconds=`0.2393`, io_mib_s=`314.24`
...
- `after_reboot`: status=`value-present`, value_exists=`True`, value=`3322359`
- `after_restore`: status=`value-present`, value_exists=`True`, value=`2636907`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.5`, cpu_multi_seconds=`0.2476`, io_mib_s=`73.18`

## Stage: post_rollback

- `status`: `ok`
- `error`: `None`
- `final`: status=`value-present`, value_exists=`True`, value=`2636908`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4543`, cpu_multi_seconds=`0.2451`, io_mib_s=`368.65`

# Registry Value Experiment - operator96-093-policy-1

- Status: **ok**
- Generated UTC: `2026-05-10T15:24:46Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Power\ForceHibernateDisabled\Policy`
- Test value: `1`
- Outcome: `completed`
...
- `status`: `ok`
- `error`: `None`
- `original`: status=`key-missing`, value_exists=`False`, value=`None`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`607.5925`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`506.5694`

## Stage: post_reboot_rollback

- `status`: `ok`
- `error`: `None`
- `restore_action`: `removed-created-key`
- `after_reboot`: status=`value-present`, value_exists=`True`, value=`1`
- `after_restore`: status=`key-missing`, value_exists=`False`, value=`None`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `settings-uri-launch`: `True` - launch-command-succeeded
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`timeout`, failure_count=`None`
- `benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`679.5826`

## Stage: post_rollback

- `status`: `ok`
- `error`: `None`
- `final`: status=`key-missing`, value_exists=`False`, value=`None`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`timeout`, failure_count=`None`
- `benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`711.6674`

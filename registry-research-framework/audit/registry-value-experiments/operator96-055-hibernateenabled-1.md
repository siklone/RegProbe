# Registry Value Experiment - operator96-055-hibernateenabled-1

- Status: **ok**
- Generated UTC: `2026-05-09T22:43:26Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Power\HibernateEnabled`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.441`, cpu_multi_seconds=`0.2269`, io_mib_s=`427.77`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4374`, cpu_multi_seconds=`0.2335`, io_mib_s=`263.29`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4686`, cpu_multi_seconds=`0.23`, io_mib_s=`409.75`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4402`, cpu_multi_seconds=`0.2229`, io_mib_s=`383.04`

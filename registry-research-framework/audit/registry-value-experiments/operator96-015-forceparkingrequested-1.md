# Registry Value Experiment - operator96-015-forceparkingrequested-1

- Status: **ok**
- Generated UTC: `2026-05-09T12:38:05Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel\ForceParkingRequested`
- Test value: `1`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4315`, cpu_multi_seconds=`0.2199`, io_mib_s=`477.08`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4416`, cpu_multi_seconds=`0.2191`, io_mib_s=`259.78`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4427`, cpu_multi_seconds=`0.2203`, io_mib_s=`472.26`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4439`, cpu_multi_seconds=`0.2225`, io_mib_s=`455.97`

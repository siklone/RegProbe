# Registry Value Experiment - operator96-034-disablecontrolflowguardexportsuppression-0

- Status: **ok**
- Generated UTC: `2026-05-09T19:21:21Z`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4898`, cpu_multi_seconds=`0.3815`, io_mib_s=`78.83`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4648`, cpu_multi_seconds=`0.2443`, io_mib_s=`362.48`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.6236`, cpu_multi_seconds=`0.2713`, io_mib_s=`162`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4698`, cpu_multi_seconds=`0.2814`, io_mib_s=`296.09`

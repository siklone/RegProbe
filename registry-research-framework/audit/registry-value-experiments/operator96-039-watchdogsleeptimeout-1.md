# Registry Value Experiment - operator96-039-watchdogsleeptimeout-1

- Status: **ok**
- Generated UTC: `2026-05-09T20:13:06Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Power\WatchdogSleepTimeout`
- Test value: `1`
...
- `status`: `ok`
- `error`: `None`
- `original`: status=`value-present`, value_exists=`True`, value=`300`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4373`, cpu_multi_seconds=`0.2517`, io_mib_s=`369.42`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4411`, cpu_multi_seconds=`0.241`, io_mib_s=`364.08`
...
- `after_restore`: status=`value-present`, value_exists=`True`, value=`300`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4598`, cpu_multi_seconds=`0.2621`, io_mib_s=`307.61`

## Stage: post_rollback

- `status`: `ok`
- `error`: `None`
- `final`: status=`value-present`, value_exists=`True`, value=`300`
- `smoke.failure_count`: `1`
- `smoke.hard_failure_count`: `0`
- `smoke.best_effort_failure_count`: `1`
- `shell-process-presence`: `True` - explorer=True;SearchHost=True;ShellExperienceHost=False;sihost=True;StartMenuExperienceHost=True
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4453`, cpu_multi_seconds=`0.2682`, io_mib_s=`346.46`

# Registry Value Experiment - operator96-043-sleepstudydisabled-0

- Status: **ok**
- Generated UTC: `2026-05-09T21:13:59Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Power\SleepStudyDisabled`
- Test value: `0`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4411`, cpu_multi_seconds=`0.2473`, io_mib_s=`342.85`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4543`, cpu_multi_seconds=`0.3679`, io_mib_s=`344.07`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.456`, cpu_multi_seconds=`0.2457`, io_mib_s=`351.54`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4466`, cpu_multi_seconds=`0.2409`, io_mib_s=`267.27`

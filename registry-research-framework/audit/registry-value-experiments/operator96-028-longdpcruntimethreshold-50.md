# Registry Value Experiment - operator96-028-longdpcruntimethreshold-50

- Status: **ok**
- Generated UTC: `2026-05-09T17:22:08Z`
...
- `after_apply`: status=`value-present`, value_exists=`True`, value=`50`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.4734`, cpu_multi_seconds=`0.2797`, io_mib_s=`238.92`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`0.4673`, cpu_multi_seconds=`0.3258`, io_mib_s=`290.26`
...
- `after_reboot`: status=`value-present`, value_exists=`True`, value=`50`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.5366`, cpu_multi_seconds=`0.3052`, io_mib_s=`121.59`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`0.5185`, cpu_multi_seconds=`0.3671`, io_mib_s=`209.07`

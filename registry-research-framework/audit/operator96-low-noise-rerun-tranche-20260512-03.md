...
| `operator96-020-forceidlegraceperiod-0` | `harmful` | `low` | `ok` | `ok` | `True` | `ok`/`0` | `-19.948` | `-2.71` | `registry-research-framework/audit/registry-value-experiments-low-noise-20260510/operator96-020-forceidlegraceperiod-0.json` |
| `operator96-020-forceidlegraceperiod-1` | `harmful` | `low` | `ok` | `ok` | `True` | `ok`/`0` | `-56.705` | `-13.05` | `registry-research-framework/audit/registry-value-experiments-low-noise-20260510/operator96-020-forceidlegraceperiod-1.json` |

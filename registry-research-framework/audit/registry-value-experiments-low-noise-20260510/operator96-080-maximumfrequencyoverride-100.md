# Registry Value Experiment - operator96-080-maximumfrequencyoverride-100

- Status: **ok**
- Generated UTC: `2026-05-13T16:33:26Z`
- Target: `HKLM\SYSTEM\CurrentControlSet\Control\Power\MaximumFrequencyOverride`
- Test value: `100`
- Outcome: `completed`
...
- `after_apply`: status=`value-present`, value_exists=`True`, value=`100`
...
- `benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`2043.0821`
- `baseline_smoke.failure_count`: `1`
- `baseline_smoke.hard_failure_count`: `0`
- `baseline_smoke.best_effort_failure_count`: `1`
- `baseline_benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`1164.5531`
...
- `after_reboot`: status=`value-present`, value_exists=`True`, value=`100`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`1139.3413`
...
- `store-uri-launch`: `False` - This command cannot be run due to the error: The operation attempted is not supported.
- `interactive_user_smoke`: status=`ok`, failure_count=`0`
- `benchmarks`: status=`ok`, cpu_single_seconds=`None`, cpu_multi_seconds=`None`, io_mib_s=`1149.98`

...
- Program: `reg.exe`
- Probe: `ghidra-symbolized-reg-exe-0x128b-power-control-allow-audio-to-enable-execution-required-power-requests`
- Timestamp: `2026-04-14T04:31:05.045270900Z`
- PDB source: `C:\Tools\Symbols\ghidra-symbolized-reg-exe-0x128b-power-control-allow-audio-to-enable-execution-required-power-requests`

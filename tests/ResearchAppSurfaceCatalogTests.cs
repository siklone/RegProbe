...
public sealed class ResearchAppSurfaceCatalogTests
{
    ...
    public void Catalog_Surfaces_Validated_Research_Cards_From_App_Surface_Manifest()
    {
        ...
        Assert.IsType<RegistryValueTweak>(disableAppSuggestionsTweak);
        ...
        Assert.IsType<RegistryValueTweak>(disableLanguageListAccessTweak);
        ...
        Assert.IsType<RegistryValueTweak>(graphicsTdrDdiDelayTweak);
        Assert.IsType<RegistryValueTweak>(graphicsTdrDelayTweak);
        Assert.IsType<RegistryValuePresetBatchTweak>(graphicsTdrLevelTweak);
        Assert.IsType<RegistryValueTweak>(dwmDisableOverlayMinFpsTweak);
        Assert.IsType<RegistryValueTweak>(graphicsTdrLimitCountTweak);
        Assert.IsType<RegistryValueTweak>(graphicsTdrLimitTimeTweak);
        ...
        Assert.IsType<RegistryValueTweak>(memoryNonpagedPoolDynamicTweak);
        Assert.IsType<RegistryValuePresetBatchTweak>(memoryPagedPoolDynamicTweak);
        Assert.IsType<RegistryValueTweak>(memoryRegistryQuotaDefaultTweak);
        ...
        Assert.IsType<RegistryValueTweak>(disableAcrylicLogonTweak);
        ...
        Assert.IsType<RegistryValueTweak>(disableLockScreenCameraTweak);
        Assert.IsType<RegistryValueTweak>(disableLockScreenChangesTweak);
        ...
        Assert.IsType<RegistryValueTweak>(disableAutoMaintenanceTweak);
        Assert.IsType<RegistryValueTweak>(disableBackgroundGpUpdatesTweak);
        ...
        Assert.IsType<RegistryValueBatchTweak>(disableWindowsFirewallTweak);
        Assert.IsType<DisableSystemMitigationsTweak>(disableSystemMitigationsTweak);
        Assert.IsType<RegistryValueBatchTweak>(disableVbsTweak);
        Assert.IsType<RegistryValueBatchTweak>(disableWuDriverUpdatesTweak);
        Assert.IsType<RegistryValueBatchTweak>(powershellUnrestrictedTweak);

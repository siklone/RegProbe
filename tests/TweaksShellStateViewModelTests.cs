...
public sealed class TweaksShellStateViewModelTests
{
    ...
    public void FilterOptions_ExposeStableLabelsAndValues_ForDropdownBinding()
    {
        ...
        Assert.Collection(
            ...
            option =>
            {
                Assert.Equal("HOLD", option.Label);
    ...
    public void CycleFilters_ChangesStatusAndScopeWithoutDropdownDependency()
    {
        ...
        viewModel.CycleStatusFilterCommand.Execute(null);
        ...
        Assert.Equal("HOLD", viewModel.StatusFilterDisplayText);
        viewModel.CycleStatusFilterCommand.Execute(null);
        ...
        viewModel.CycleScopeFilterCommand.Execute(null);

...
class PowerRequestOverrideHandoffVerifierTests(unittest.TestCase):
    def test_verify_bundle_reports_ok_status(self) -> None:
        ...
        self.assertEqual(payload["output_contract"], ["ready_for_execute", "summary", "blockers", "operator_checklist", "next_steps"])
        self.assertEqual(len(payload["operator_checklist"]), 4)
        self.assertEqual(
    ...
    def test_cli_markdown_outputs_current_run_summary(self) -> None:
        ...
        self.assertIn("## Operator Checklist", proc.stdout)
    ...
    def test_verify_bundle_reports_error_blockers_when_paths_are_missing(self) -> None:
        ...
        self.assertEqual(payload["output_contract"], ["ready_for_execute", "summary", "blockers", "operator_checklist", "next_steps"])
        self.assertEqual(len(payload["operator_checklist"]), 3)
        self.assertEqual(
            payload["next_steps"]["recommended_example"],

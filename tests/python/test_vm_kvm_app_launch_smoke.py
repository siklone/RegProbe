...
class VmKvmAppLaunchSmokeTests(unittest.TestCase):
    ...
    def test_main_passes_working_dir_to_launch_step(self) -> None:
        argv = [
            "run-guest-app-launch-smoke.py",
            "--linger-seconds",
            "0",
        ...
        payload = json.loads(stdout.getvalue())
        self.assertEqual(exit_code, 0)
        self.assertEqual(launch_mock.call_args.kwargs["working_dir"], r"C:\RegProbeSource")
        self.assertEqual(payload["working_dir"], r"C:\RegProbeSource")

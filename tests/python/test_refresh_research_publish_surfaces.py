    ...
    def test_build_refresh_steps_uses_dependency_order(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "registry-research-framework/scripts/generate_rejected_closure_ledger.py",
                "registry-research-framework/scripts/generate_promotion_eligible_review_pack.py",
                "registry-research-framework/scripts/generate_clean_state_report.py",

...
public sealed class TweakProvenanceCatalogServiceTests : IDisposable
{
    ...
    {
        _rootDirectory = Path.Combine(Path.GetTempPath(), "WindowsOptimizer-ProvenanceTests", Guid.NewGuid().ToString("N"));
              ...
              "Entries": [
                {
                  ...
                  "Category": "Cleanup",
                  "Risk": "Advanced",
                  "Source": "WindowsOptimizer.Engine\\\\Tweaks\\\\Commands\\\\Cleanup\\\\ClearEventLogsTweak.cs#L15",

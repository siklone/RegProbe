...
Windows is observed as exposing the setting as a real control surface, but the repo does not yet have enough live proof to say the behavior is honored consistently on the checked-in build set.

...
- `registry-research-framework/scripts/verify_power_request_override_handoff_bundle.py`
  verifies that the current PowerRequestOverride handoff bundle is structurally intact and echoes the exact current-run promotion preview, compact blocker summary, and next-step guidance in JSON or markdown form

...
| <a id="cleanup.prefetch-files"></a> `cleanup.prefetch-files` | Clear Prefetch Files | Clears Windows prefetch files from %WINDIR%\\Prefetch. Files may be regenerated by Windows over time. | Safe | `engine/Tweaks/Commands/Cleanup/ClearPrefetchFilesTweak.cs#L11` |

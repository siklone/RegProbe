...
| <a id="misc.disable-onedrive"></a> `misc.disable-onedrive` | Disable OneDrive | Writes OneDrive policy and Explorer values that disable default-save and sync features, set PreventNetworkTrafficPreUserSignIn, and unpin... | Advanced | `engine/Tweaks/Misc/DisableOneDriveTweaks.cs#L36` |
...
| <a id="misc.optimize-7zip-settings"></a> `misc.optimize-7zip-settings` | Configure 7-Zip Context Menu Settings | Sets the 7-Zip context-menu values for CascadedMenu, ElimDupExtract, MenuIcons, and WriteZoneIdExtract. | Safe | `engine/Tweaks/Misc/SevenZipSettingsTweak.cs#L54` |
<!-- TWEAK INDEX END -->

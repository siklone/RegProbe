...
| --- | --- | --- | --- | --- |
| <a id="audio.disable-spatial-audio"></a> `audio.disable-spatial-audio` | Disable Spatial Audio | Disables the low-latency spatial-audio policy flag for supported audio configurations. | Advanced | `app/Services/TweakProviders/AudioTweakProvider.cs#L22` |
...
| <a id="peripheral.keyboard-optimize-repeat"></a> `peripheral.keyboard-optimize-repeat` | Optimize Keyboard Repeat Rate | Sets keyboard to minimum repeat delay, maximum repeat rate, and a 900 ms cursor blink interval. | Safe | `engine/Tweaks/Peripheral/KeyboardTweaks.cs#L27` |

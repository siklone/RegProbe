...
`AllowBuildPreview` is retained here as older build reference material through V1703-era documentation. `Computer Configuration > Administrative Templates > Windows Component > Windows Update > Windows Update for Business : Manage Preview Builds` remains the relevant path for newer Windows 10+ versions.
...
| --- | --- | --- | --- | --- |
| <a id="privacy.block-microsoft-accounts"></a> `privacy.block-microsoft-accounts` | Block Microsoft Accounts | Prevents adding or signing in with Microsoft accounts. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1773` |
| <a id="privacy.deny-app-access"></a> `privacy.deny-app-access` | Deny App Access (Except Microphone) | Forces Windows apps to be denied access to sensitive capabilities. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1646` |
| <a id="privacy.disable-activity-history"></a> `privacy.disable-activity-history` | Disable Activity History | Stops publishing and uploading activity history (Timeline) across devices. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L45` |
| <a id="privacy.disable-advertising-id"></a> `privacy.disable-advertising-id` | Disable Advertising ID | Prevents Windows from tracking you for advertising personalization. | Safe | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L32` |
| <a id="privacy.disable-app-diagnostics"></a> `privacy.disable-app-diagnostics` | Disable App Diagnostics | Prevents apps from accessing diagnostic information. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L2282` |
| <a id="privacy.disable-app-launch-tracking"></a> `privacy.disable-app-launch-tracking` | Disable App Launch Tracking | Stops Windows from tracking app launches for Start/Search personalization. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1305` |
| <a id="privacy.disable-app-suggestions"></a> `privacy.disable-app-suggestions` | Disable App Suggestions in Start | Prevents Windows from suggesting promoted apps in the Start menu. | Safe | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L98` |
| <a id="privacy.disable-application-compatibility"></a> `privacy.disable-application-compatibility` | Disable Application Compatibility | Turns off Windows application compatibility components, telemetry, and related tasks. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1813` |
| <a id="privacy.disable-application-telemetry"></a> `privacy.disable-application-telemetry` | Disable Application Telemetry | Stops the Application Telemetry engine from collecting usage data for compatibility. | Risky | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L60` |
| <a id="privacy.disable-background-apps"></a> `privacy.disable-background-apps` | Disable Background Apps | Prevents Windows apps from running in the background, saving battery and resources. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L179` |
| <a id="privacy.disable-biometrics"></a> `privacy.disable-biometrics` | Disable Biometrics | Turns off Windows biometric features on this device. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1326` |
| <a id="privacy.disable-biometrics-domain-logon"></a> `privacy.disable-biometrics-domain-logon` | Disable Biometrics for Domain Logon | Prevents domain users from signing in with biometrics. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1346` |
| <a id="privacy.disable-biometrics-logon"></a> `privacy.disable-biometrics-logon` | Disable Biometrics Logon | Prevents users from signing in with biometrics. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1336` |
| <a id="privacy.disable-camera"></a> `privacy.disable-camera` | Disable Camera Access (Policy) | Disables camera access for all applications via group policy. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L167` |
| <a id="privacy.disable-ceip"></a> `privacy.disable-ceip` | Disable CEIP | Opts out of Customer Experience Improvement Program data collection. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1635` |
| <a id="privacy.disable-cli-telemetry"></a> `privacy.disable-cli-telemetry` | Disable PowerShell & .NET CLI Telemetry | Opts out of PowerShell and .NET CLI telemetry for the current user. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1019` |
| <a id="privacy.disable-consumer-account-content"></a> `privacy.disable-consumer-account-content` | Disable Consumer Account State Content | Prevents Windows experiences from using cloud consumer account content. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1172` |
| <a id="privacy.disable-copilot"></a> `privacy.disable-copilot` | Disable Windows Copilot | Turns off the Windows Copilot AI experience for the current user. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L128` |
| <a id="privacy.disable-cross-device-experiences"></a> `privacy.disable-cross-device-experiences` | Disable Cross-Device Experiences | Disables continue experiences on this device (CDP). | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L988` |
| <a id="privacy.disable-device-name-telemetry"></a> `privacy.disable-device-name-telemetry` | Disable Device Name in Diagnostics | Prevents the device name from being included in diagnostic data. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1595` |
| <a id="privacy.disable-diagnostic-data"></a> `privacy.disable-diagnostic-data` | Disable Diagnostic Data (Policy) | Sets diagnostic data collection to the minimum level required for Windows to operate. | Risky | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L20` |
| <a id="privacy.disable-diagnostic-data-delete"></a> `privacy.disable-diagnostic-data-delete` | Disable Diagnostic Data Deletion | Disables the ability to delete diagnostic data in Settings. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1545` |
| <a id="privacy.disable-diagnostic-data-viewer"></a> `privacy.disable-diagnostic-data-viewer` | Disable Diagnostic Data Viewer | Blocks access to the Diagnostic Data Viewer in Settings. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1535` |
| <a id="privacy.disable-edge-search-suggestions"></a> `privacy.disable-edge-search-suggestions` | Disable Edge Search Suggestions | Turns off search suggestions in Microsoft Edge address bar. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1192` |
| <a id="privacy.disable-f1-help"></a> `privacy.disable-f1-help` | Disable F1 Help | Disables F1 help by renaming HelpPane.exe. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L2222` |
| <a id="privacy.disable-feedback-notifications"></a> `privacy.disable-feedback-notifications` | Disable Feedback Notifications | Stops Windows Feedback prompts from appearing. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1625` |
| <a id="privacy.disable-file-history"></a> `privacy.disable-file-history` | Disable File History | Turns off File History backups. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1605` |
| <a id="privacy.disable-font-providers"></a> `privacy.disable-font-providers` | Disable Font Providers | Prevents Windows from downloading fonts from online providers. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1793` |
| <a id="privacy.disable-inking-typing-personalization"></a> `privacy.disable-inking-typing-personalization` | Disable Inking & Typing Personalization | Stops sending inking and typing data to Microsoft. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1852` |
| <a id="privacy.disable-kms-activation-telemetry"></a> `privacy.disable-kms-activation-telemetry` | Disable KMS Activation Telemetry | Stops KMS client activation data from being sent to Microsoft. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1783` |
| <a id="privacy.disable-language-list-access"></a> `privacy.disable-language-list-access` | Disable Website Access to Language List | Prevents websites from accessing the language list for content customization. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1032` |
| <a id="privacy.disable-local-security-questions"></a> `privacy.disable-local-security-questions` | Disable Local Security Questions | Prevents setting security questions for local accounts. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1803` |
| <a id="privacy.disable-location"></a> `privacy.disable-location` | Disable Location Services | Turns off location services for this device. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1203` |
| <a id="privacy.disable-location-consent"></a> `privacy.disable-location-consent` | Disable Location Consent (User) | Denies location capability access for the current user. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1213` |
| <a id="privacy.disable-location-consent-system"></a> `privacy.disable-location-consent-system` | Disable Location Consent (System) | Denies location capability access at the system level. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1240` |
| <a id="privacy.disable-location-scripting"></a> `privacy.disable-location-scripting` | Disable Location Scripting | Disables location scripting support for apps and scripts. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1250` |
| <a id="privacy.disable-location-services"></a> `privacy.disable-location-services` | Disable Location Services | Turns off location tracking services system-wide for all users. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L155` |
| <a id="privacy.disable-location-tracking"></a> `privacy.disable-location-tracking` | Disable Location Tracking | Disables location tracking services system-wide. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L2292` |
| <a id="privacy.disable-mdm-enrollment"></a> `privacy.disable-mdm-enrollment` | Disable MDM Enrollment | Prevents new MDM enrollments for this device. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1615` |
| <a id="privacy.disable-message-sync"></a> `privacy.disable-message-sync` | Disable Message Sync | Stops SMS/MMS cloud sync for this device. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1720` |
| <a id="privacy.disable-offline-files"></a> `privacy.disable-offline-files` | Disable Offline Files | Disables Offline Files (CSC) via policy, services, tasks, and Sync Center. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L233` |
| <a id="privacy.disable-onesettings-downloads"></a> `privacy.disable-onesettings-downloads` | Disable OneSettings Downloads | Stops Windows from downloading configuration settings from OneSettings. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1555` |
| <a id="privacy.disable-online-tips"></a> `privacy.disable-online-tips` | Disable Online Tips | Stops Settings from retrieving online tips and help content. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1182` |
| <a id="privacy.disable-phone-linking"></a> `privacy.disable-phone-linking` | Disable Phone Linking | Prevents the device from participating in Phone-PC linking. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L998` |
| <a id="privacy.disable-recall"></a> `privacy.disable-recall` | Disable Windows Recall | Disables saving snapshots for the Recall AI feature on this user. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L141` |
| <a id="privacy.disable-reserved-storage"></a> `privacy.disable-reserved-storage` | Disable Reserved Storage | Disables Windows reserved storage for updates. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1316` |
| <a id="privacy.disable-resume"></a> `privacy.disable-resume` | Disable Resume Experiences | Turns off Resume (start on one device, continue on this PC). | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1008` |
| <a id="privacy.disable-rsop-logging"></a> `privacy.disable-rsop-logging` | Disable RSoP Logging | Turns off Resultant Set of Policy logging on this device. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1700` |
| <a id="privacy.disable-search-box-suggestions"></a> `privacy.disable-search-box-suggestions` | Disable Search Box Suggestions | Stops File Explorer from showing recent search suggestions. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1103` |
| <a id="privacy.disable-search-history"></a> `privacy.disable-search-history` | Disable Search History | Prevents search history from being stored for this user. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1092` |
| <a id="privacy.disable-sensors"></a> `privacy.disable-sensors` | Disable Sensors | Turns off hardware sensor access for apps and system features. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1270` |
| <a id="privacy.disable-sleep-study-diagnostics"></a> `privacy.disable-sleep-study-diagnostics` | Disable Sleep Study Diagnostics | Disables sleep study diagnostic event channels. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1895` |
| <a id="privacy.disable-steps-recorder"></a> `privacy.disable-steps-recorder` | Disable Steps Recorder | Disables Steps Recorder to prevent recording user actions. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1280` |
| <a id="privacy.disable-suggestions"></a> `privacy.disable-suggestions` | Disable Suggestions & Tips | Turns off Windows tips, welcome experiences, and Settings recommendations. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1156` |
| <a id="privacy.disable-suggestions-cdm"></a> `privacy.disable-suggestions-cdm` | Disable Content Delivery Manager Suggestions | Disables various suggestions and auto-installed apps from the Content Delivery Manager. | Safe | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L111` |
| <a id="privacy.disable-sync-settings"></a> `privacy.disable-sync-settings` | Disable Settings Sync | Disables syncing Windows settings and related data across devices. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1063` |
| <a id="privacy.disable-telemetry-change-notifications"></a> `privacy.disable-telemetry-change-notifications` | Disable Diagnostic Data Change Notifications | Stops opt-in change notifications for diagnostic data. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1585` |
| <a id="privacy.disable-telemetry-optin-ui"></a> `privacy.disable-telemetry-optin-ui` | Disable Diagnostic Data Opt-in UI | Disables the diagnostic data opt-in settings UI in Settings. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1575` |
| <a id="privacy.disable-wer"></a> `privacy.disable-wer` | Disable Windows Error Reporting | Disables automatic generation and upload of error reports to Microsoft. | Advanced | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L72` |
| <a id="privacy.disable-windows-location-provider"></a> `privacy.disable-windows-location-provider` | Disable Windows Location Provider | Disables the Windows Location Provider for all apps. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1260` |
| <a id="privacy.disable-windows-tips"></a> `privacy.disable-windows-tips` | Disable Windows Tips & Tricks | Stops Windows from showing tips, shortcuts, and suggestions on the lock screen and in Settings. | Safe | `app/Services/TweakProviders/PrivacyTweakProvider.cs#L85` |
| <a id="privacy.disable-wmplayer-telemetry"></a> `privacy.disable-wmplayer-telemetry` | Disable Windows Media Player Telemetry | Turns off usage tracking and online metadata for Windows Media Player. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1043` |
| <a id="privacy.hide-last-logged-in-user"></a> `privacy.hide-last-logged-in-user` | Hide Last Logged-In User | Removes the last signed-in username from the sign-in screen. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1921` |
| <a id="privacy.hide-recommended-personalized-sites"></a> `privacy.hide-recommended-personalized-sites` | Hide Start Personalized Site Recommendations (Policy) | Removes personalized website recommendations from Start for all users. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1135` |
| <a id="privacy.hide-recommended-personalized-sites-user"></a> `privacy.hide-recommended-personalized-sites-user` | Hide Start Personalized Site Recommendations (User) | Removes personalized website recommendations from Start for the current user. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1145` |
| <a id="privacy.hide-recommended-section"></a> `privacy.hide-recommended-section` | Hide Start Recommended Section (Policy) | Removes the Recommended section from the Start menu for all users. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1114` |
| <a id="privacy.hide-recommended-section-user"></a> `privacy.hide-recommended-section-user` | Hide Start Recommended Section (User) | Removes the Recommended section from the Start menu for the current user. | Safe | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1124` |
| <a id="privacy.hide-username-at-signin"></a> `privacy.hide-username-at-signin` | Hide Username at Sign-In | Hides the username after credentials are entered at sign-in. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1931` |
| <a id="privacy.limit-diagnostic-log-collection"></a> `privacy.limit-diagnostic-log-collection` | Limit Diagnostic Log Collection | Prevents additional diagnostic logs from being collected. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1525` |
| <a id="privacy.limit-dump-collection"></a> `privacy.limit-dump-collection` | Limit Dump Collection | Limits diagnostic dumps to reduce the data sent in diagnostics. | Risky | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1565` |
| <a id="privacy.troubleshooter-dont-run"></a> `privacy.troubleshooter-dont-run` | Troubleshooter: Don't Run Any | Prevents recommended troubleshooters from running automatically. | Advanced | `app/Services/TweakProviders/LegacyTweakProvider.cs#L1710` |
<!-- TWEAK INDEX END -->

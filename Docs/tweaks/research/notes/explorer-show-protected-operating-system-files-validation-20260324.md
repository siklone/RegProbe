...
```text
Source file:
H:\Temp\vm-tooling-staging\showsuperhidden-result.txt
...
```text
H:\Temp\vm-tooling-staging\showsuperhidden-0-hits.csv
H:\Temp\vm-tooling-staging\showsuperhidden-1-hits.csv
```

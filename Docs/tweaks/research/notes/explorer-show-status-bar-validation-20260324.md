...
```text
Source file:
H:\Temp\vm-tooling-staging\showstatusbar-result.txt
...
```text
H:\Temp\vm-tooling-staging\showstatusbar-0-hits.csv
H:\Temp\vm-tooling-staging\showstatusbar-1-hits.csv
```

...
Artifacts:
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-cpu3.watch.txt
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-cpu3.etl
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-cpu3.winsat.txt
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-cpu3.perf.csv
```
...
Artifacts:
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-mem2.watch.txt
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-mem2.etl
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-mem2.winsat.txt
- H:\Temp\vm-tooling-staging\thread-dpc-enable-0-mem2.perf.csv
```

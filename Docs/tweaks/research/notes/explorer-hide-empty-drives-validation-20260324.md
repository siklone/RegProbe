...
```text
Source file:
H:\Temp\vm-tooling-staging\hideemptydrives-result.txt
...
```text
H:\Temp\vm-tooling-staging\hideemptydrives-0-hits.csv
H:\Temp\vm-tooling-staging\hideemptydrives-1-hits.csv
```

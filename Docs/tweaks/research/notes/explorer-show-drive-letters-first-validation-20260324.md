...
```text
Source file:
H:\Temp\vm-tooling-staging\showdrivelettersfirst-result.txt
...
```text
H:\Temp\vm-tooling-staging\showdrivelettersfirst-0-hits.csv
H:\Temp\vm-tooling-staging\showdrivelettersfirst-1-hits.csv
```

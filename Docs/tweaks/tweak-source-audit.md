...
| --- | --- | --- | --- | --- |
| `explorer.disable-taskbar-chat` | Hide Taskbar Chat Icon | CreateRegistryTweak | Software\Policies\Microsoft\Windows\Windows Chat, ChatIcon | `WindowsOptimizer.App\Services\TweakProviders\VisibilityTweakProvider.cs#L175` |

...
These assets are intentionally lightweight and reproducible. The generator emits both SVG source panels and PNG captures so the README can show the checked-in shell without depending on a flaky VM screenshot lane.

## Source Of Truth

The checked-in preview assets are generated by:
...
- confirm the README screenshots still match the checked-in labels and layout

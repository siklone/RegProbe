...
| --- | --- | --- | --- | --- |
| <a id="performance.disable-animations"></a> `performance.disable-animations` | Disable Window Animations | Disables window animations to make the UI feel snappier. Reference: Microsoft PC Performance Guidelines | Safe | `app\Services\TweakProviders\PerformanceTweakProvider.cs#L27` |
| <a id="performance.disable-menu-show-delay"></a> `performance.disable-menu-show-delay` | Remove Menu Show Delay | Removes the artificial delay when showing menus for a more responsive feel. | Safe | `app\Services\TweakProviders\PerformanceTweakProvider.cs#L40` |
| <a id="performance.disable-taskbar-animations"></a> `performance.disable-taskbar-animations` | Disable Taskbar Animations | Disables taskbar animations for a slight performance boost. | Safe | `app\Services\TweakProviders\PerformanceTweakProvider.cs#L53` |
<!-- TWEAK INDEX END -->

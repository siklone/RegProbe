...
| --- | --- | --- | --- | --- |
| <a id="explorer.always-show-icons-never-thumbnails"></a> `explorer.always-show-icons-never-thumbnails` | Always Show Icons, Never Thumbnails | Uses file icons instead of thumbnail previews in File Explorer. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L122` |
| <a id="explorer.disable-low-disk-space-warning"></a> `explorer.disable-low-disk-space-warning` | Disable Low Disk Space Warning | Turns off the low disk space warning notification. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L226` |
| <a id="explorer.disable-taskbar-chat"></a> `explorer.disable-taskbar-chat` | Hide Taskbar Chat Icon | Hides the Microsoft Teams Chat icon from the taskbar by default. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L214` |
| <a id="explorer.enable-explorer-compact-mode"></a> `explorer.enable-explorer-compact-mode` | Enable Compact View | Reduces the spacing between items in File Explorer for a more information-dense view. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L70` |
| <a id="explorer.hide-empty-drives"></a> `explorer.hide-empty-drives` | Hide Empty Drives | Hides drives with no media present from File Explorer views such as This PC. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L174` |
| <a id="explorer.launch-folder-windows-in-a-separate-process"></a> `explorer.launch-folder-windows-in-a-separate-process` | Launch Folder Windows in a Separate Process | Runs File Explorer folder windows in a separate process for isolation and troubleshooting. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L161` |
| <a id="explorer.show-compressed-and-encrypted-files-in-color"></a> `explorer.show-compressed-and-encrypted-files-in-color` | Show Compressed and Encrypted Files in Color | Uses special filename colors for compressed and encrypted NTFS files in File Explorer. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L135` |
| <a id="explorer.show-drive-letters-first"></a> `explorer.show-drive-letters-first` | Show Drive Letters First | Shows drive letters more prominently in File Explorer drive labels. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L148` |
| <a id="explorer.show-file-extensions"></a> `explorer.show-file-extensions` | Show File Extensions | Shows the file extension (e.g., .txt, .exe) for all known file types in File Explorer. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L44` |
| <a id="explorer.show-full-path"></a> `explorer.show-full-path` | Show Full Path in Title Bar | Displays the complete directory path in the title bar of File Explorer windows. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L57` |
| <a id="explorer.show-hidden-files"></a> `explorer.show-hidden-files` | Show Hidden Files and Folders | Configures File Explorer to show files and folders marked with the hidden attribute. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L18` |
| <a id="explorer.show-info-tips"></a> `explorer.show-info-tips` | Show Explorer Info Tips | Shows pop-up descriptions for folders and desktop items in File Explorer. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L96` |
| <a id="explorer.show-protected-operating-system-files"></a> `explorer.show-protected-operating-system-files` | Show Protected Operating System Files | Shows protected operating system files in File Explorer. Best kept for advanced troubleshooting. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L31` |
| <a id="explorer.show-recent-items"></a> `explorer.show-recent-items` | Show Recent Items In Home | Shows recently used files in the Home section of File Explorer. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L187` |
| <a id="explorer.show-status-bar"></a> `explorer.show-status-bar` | Show Explorer Status Bar | Shows the File Explorer status bar at the bottom of Explorer windows. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L83` |
| <a id="explorer.show-type-overlay"></a> `explorer.show-type-overlay` | Display File Icons on Thumbnails | Shows the file-type icon overlay on thumbnail previews in File Explorer. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L109` |
| <a id="explorer.taskbar-alignment-left"></a> `explorer.taskbar-alignment-left` | Align Taskbar to Left | Moves the Taskbar icons and Start button to the traditional left alignment (Windows 11). | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L201` |
| <a id="visibility.default-account-picture"></a> `visibility.default-account-picture` | Use Default Account Picture | Forces the default account picture for all users on this device. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L264` |
| <a id="visibility.disable-acrylic-logon"></a> `visibility.disable-acrylic-logon` | Disable Acrylic Logon Background | Disables the acrylic blur on the logon background image. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L490` |
| <a id="visibility.disable-common-control-animations"></a> `visibility.disable-common-control-animations` | Disable Common Control Animations | Turns off common control and window animations for the current user. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L239` |
| <a id="visibility.disable-first-signin-animation"></a> `visibility.disable-first-signin-animation` | Disable First Sign-In Animation | Skips the first sign-in animation and Microsoft account opt-in prompt. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L288` |
| <a id="visibility.disable-lock-screen"></a> `visibility.disable-lock-screen` | Disable Lock Screen | Skips the lock screen and goes directly to the sign-in screen. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L430` |
| <a id="visibility.disable-lock-screen-camera"></a> `visibility.disable-lock-screen-camera` | Disable Lock Screen Camera | Prevents the lock screen camera from being invoked. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L442` |
| <a id="visibility.disable-lock-screen-changes"></a> `visibility.disable-lock-screen-changes` | Prevent Changing Lock Screen | Prevents users from changing the lock screen image. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L478` |
| <a id="visibility.disable-lock-screen-motion"></a> `visibility.disable-lock-screen-motion` | Disable Lock Screen Background Motion | Stops the subtle motion effect on the lock screen background. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L466` |
| <a id="visibility.disable-lock-screen-slideshow"></a> `visibility.disable-lock-screen-slideshow` | Disable Lock Screen Slideshow | Prevents lock screen slideshows from running. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L454` |
| <a id="visibility.disable-spotlight-action-center"></a> `visibility.disable-spotlight-action-center` | Disable Windows Spotlight on Action Center | Stops Windows Spotlight notifications in Action Center. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L377` |
| <a id="visibility.disable-spotlight-desktop-collection"></a> `visibility.disable-spotlight-desktop-collection` | Disable Spotlight Collection on Desktop | Removes the Spotlight collection option for desktop backgrounds. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L403` |
| <a id="visibility.disable-spotlight-features"></a> `visibility.disable-spotlight-features` | Disable Windows Spotlight Features | Turns off Windows Spotlight features for the current user. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L351` |
| <a id="visibility.disable-spotlight-settings"></a> `visibility.disable-spotlight-settings` | Disable Windows Spotlight on Settings | Stops Windows Spotlight suggestions in Settings. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L390` |
| <a id="visibility.disable-spotlight-third-party"></a> `visibility.disable-spotlight-third-party` | Disable Spotlight Third-Party Suggestions | Stops Windows Spotlight from suggesting third-party content. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L416` |
| <a id="visibility.disable-spotlight-welcome"></a> `visibility.disable-spotlight-welcome` | Disable Windows Spotlight Welcome Experience | Disables the Windows Spotlight welcome experience. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L364` |
| <a id="visibility.disable-wcn-wizards"></a> `visibility.disable-wcn-wizards` | Disable Windows Connect Now Wizards | Disables Windows Connect Now setup wizards for wireless and device setup. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L276` |
| <a id="visibility.disable-widgets"></a> `visibility.disable-widgets` | Disable Widgets (Policy) | Disables the Widgets/News and Interests feature via policy. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L313` |
| <a id="visibility.disable-window-animations"></a> `visibility.disable-window-animations` | Disable Window Animations | Disables window animations like minimize and restore. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L252` |
| <a id="visibility.force-classic-control-panel"></a> `visibility.force-classic-control-panel` | Force Classic Control Panel View | Always open Control Panel in the icon view. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L515` |
| <a id="visibility.hide-language-bar"></a> `visibility.hide-language-bar` | Hide Language Bar | Hides the language bar UI for the current user. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L300` |
| <a id="visibility.hide-most-used-apps"></a> `visibility.hide-most-used-apps` | Hide Most Used Apps | Forces the Start menu Most used list to stay hidden. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L325` |
| <a id="visibility.hide-people-bar"></a> `visibility.hide-people-bar` | Hide People Bar | Removes the People Bar from the taskbar. | Advanced | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L337` |
| <a id="visibility.restore-classic-context-menu"></a> `visibility.restore-classic-context-menu` | Restore Classic Context Menu | Restores the Windows 10 style context menu on Windows 11. | Safe | `OpenTraceProject.App\Services\TweakProviders\VisibilityTweakProvider.cs#L502` |
<!-- TWEAK INDEX END -->

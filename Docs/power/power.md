...
| <a id="power.optimize-gaming-network"></a> `power.optimize-gaming-network` | Optimize Gaming Network Settings | Writes a more aggressive MMCSS Games task profile by raising task priority, scheduling category, and I/O priority. | Safe | `WindowsOptimizer.App\Services\TweakProviders\PowerTweakProvider.cs#L110` |

...
| <a id="power.disable-hibernation"></a> `power.disable-hibernation` | Disable Hibernation | Runs powercfg /hibernate off. This disables hibernation and removes hiberfil.sys. | Safe | `engine/Tweaks/Commands/Power/DisableHibernationTweak.cs#L13` |

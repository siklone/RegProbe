...
| <a id="power.optimize-cpu-boost"></a> `power.optimize-cpu-boost` | Apply CPU Boost Registry Bundle | Writes the CPU boost-related Control\\Power registry values used by this tweak. | Safe | `engine/Tweaks/Power/CPUPowerTweaks.cs#L86` |
